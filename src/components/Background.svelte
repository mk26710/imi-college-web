...
>
	...
	></div>
	<div
		class="absolute left-0 right-0 top-0 -z-10 m-auto mt-[50vh] h-[350px] w-[350px] rounded-full bg-purple-600 opacity-20 blur-[100px] dark:bg-purple-400 dark:opacity-10"
	></div>
	<div
		class="absolute left-0 right-0 top-0 -z-20 m-auto ml-[60vw] mt-[15vh] h-[400px] w-[400px] rounded-full bg-purple-600 opacity-20 blur-[100px] dark:bg-purple-400 dark:opacity-10"
	></div>
</div>
